...
//    _xypoints.x=_xypoints.y=0;
    self.fill = NO;
    self.fillcolor=[attributes objectForKey:@"fill"];
    ...
    self.Pinicon=[attributes objectForKey:@"id"];
    _xypoints.x=[[attributes objectForKey:@"x"]floatValue];
    _xypoints.y=[[attributes objectForKey:@"y"]floatValue];
    self.path = nil;
