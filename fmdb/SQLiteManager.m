...
-(NSString*)GetDBPath
{
	...
	return [documentsDirectory stringByAppendingPathComponent:@"UserCredentials.sqlite"];
}
...
-(void)createDatabaseIfNeeded{
	...
	//Create the complete path to the database file.
	NSString *databasePath = [documentsDirectory stringByAppendingPathComponent:@"UserCredentials.sqlite"];
	...
	NSString *dbPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"UserCredentials.sqlite"];
